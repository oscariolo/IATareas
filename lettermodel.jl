...
# ╔═╡ 25723198-2a97-11ef-3cf8-a7613abdcd6c
begin
	using Images
	using Flux
	using JLD2
...
# ╔═╡ 1d3b5f63-b08b-4119-8a51-f1bcc27bd35b
...
# ╔═╡ 055e79f7-414e-4350-b5c7-90a4b688ea13
function load_data(parsed_data,data_folder)
    if isfile(parsed_data)
        println("Loading training data from file...")
        @load parsed_data x_data y_data
    else
        println("Parsing training data and saving to file...")
        x_data, y_data = createDataset(data_folder)
        @save parsed_data x_data y_data
    end
    return x_data, y_data
end

# ╔═╡ 781e0b3c-791c-4e43-a6bd-2381000c0b79
begin
	pathtrain = "mnist_png/training"
	pathtest = "mnist_png/testing"
	parsed_train = "training_data.jld2"
	parsed_test = "testing_data.jld2"
	x_train,y_train = load_data(parsed_train,pathtrain)
	x_test,y_test = load_data(parsed_test,pathtest)

end

# ╔═╡ 1b521594-76b9-4fdd-9517-e22332e46ab3
model = Chain(
    Flux.flatten,
    Dense(784=>15,relu),
    Dense(15=>10,sigmoid),
...
# ╔═╡ 6d11a991-c93d-4593-bcb4-21b7c7e12b1e
...
# ╔═╡ dbae4ef9-1202-48a1-b179-83fa228a41a9
begin
...
manifest_format = "2.0"
project_hash = "fcf519bb7c995b57644cb44e04db78b0d8b26a39"
